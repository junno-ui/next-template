  ...
  return (
    <section className="relative py-24">
      ...
      <div className="pointer-events-none absolute inset-0 -z-10" aria-hidden="true">
        <div className="absolute top-1/2 left-1/2 h-[400px] w-[700px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-primary/[0.04] blur-[120px]" />
      </div>
      ...
      <div className="mx-auto max-w-5xl px-6">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
          {stats.map((stat) => (
            <div
              key={stat.label}
              className="group relative flex flex-col items-center rounded-2xl border border-border/20 bg-card/40 p-8 text-center transition-all duration-300 hover:border-primary/20 hover:bg-card/70 hover:shadow-lg hover:shadow-primary/5"
            >
              {/* Glow on hover */}
