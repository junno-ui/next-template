  ...
  return (
    <section className="relative isolate overflow-hidden py-24 sm:py-28">
      ...
      >
        ...
        <div className="absolute top-[20%] left-1/2 h-[460px] w-[min(92vw,960px)] -translate-x-1/2 rounded-full bg-primary/[0.065] blur-[130px]" />
        <div className="absolute right-[-10%] bottom-[-12%] h-[360px] w-[620px] rounded-full bg-chart-2/[0.04] blur-[120px]" />
