  ...
  return (
    <section id="contact" className="relative isolate overflow-hidden py-24 sm:py-28">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-[2.5rem] bg-primary px-6 py-14 text-primary-foreground shadow-2xl shadow-primary/25 sm:px-10 sm:py-16 lg:px-16">
          {/* Filled card effects */}
          <div
          ...
          <div className="relative mx-auto flex max-w-4xl flex-col items-center text-center">
            ...
            <p className="mt-5 max-w-2xl text-pretty text-[15px] leading-7 text-white/78 sm:text-base">
