      ...
      <div className="mx-auto max-w-5xl px-6">
        <div className="mb-14 text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-sm text-muted-foreground">
            Hear from the teams that use our platform to drive real results
            every day.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-3">
          {testimonials.map((t) => (
            <div
              key={t.name}
              className="group flex flex-col justify-between rounded-2xl border border-border/20 bg-card/40 p-6 transition-all duration-300 hover:border-border/40 hover:bg-card/70"
            >
              {/* Stars */}
